    ...
    <section 
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div 
          ...
          <span style={{ color: isDark ? '#9ca3af' : '#6b7280' }} className="text-sm flex items-center gap-2"><Server className="w-4 h-4"/> API Latency</span>
        ...
        <div 
          ...
          <span style={{ color: isDark ? '#9ca3af' : '#6b7280' }} className="text-sm flex items-center gap-2"><Database className="w-4 h-4"/> DB Query Time</span>
          <div className="flex items-baseline gap-1">
        ...
        <div 
          ...
          <span style={{ color: isDark ? '#9ca3af' : '#6b7280' }} className="text-sm flex items-center gap-2"><Zap className="w-4 h-4"/> Cache Hit Rate</span>
          <div className="flex items-baseline gap-1">
        ...
        <div 
          ...
          <span style={{ color: isDark ? '#9ca3af' : '#6b7280' }} className="text-sm flex items-center gap-2"><Cpu className="w-4 h-4"/> Active BG Workers</span>
          <div className="flex items-baseline gap-1">
